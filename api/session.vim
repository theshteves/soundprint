...
set lazyredraw
set ruler
set runtimepath=~/.vim,~/.vim/bundle/nerdtree,~/.vim/bundle/vim-airline,~/.vim/bundle/vim-fugitive,~/.vim/bundle/tmuxline.vim,~/.vim/bundle/vim-airline-themes,/usr/local/share/vim/vimfiles,/usr/local/share/vim/vim74,/usr/local/share/vim/vimfiles/after,~/.vim/after,~/.vim/bundle/Vundle.vim,~/.vim/bundle/nerdtree/after,~/.vim/bundle/vim-airline/after,~/.vim/bundle/vim-fugitive/after,~/.vim/bundle/tmuxline.vim/after,~/.vim/bundle/vim-airline-themes/after
set shiftwidth=4
set showmatch
set smartcase
set smartindent
...
silent only
cd ~/Desktop/code/soundprint/api
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 urls.py
badd +0 ../config/urls.py
badd +6 views.py
argglobal
silent! argdel *
argadd urls.py
